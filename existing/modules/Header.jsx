...
const Header = ({ header, metadata }) => {
  ...
  return (
    <div
      className={classNames('fixed top-0 z-20 w-full transition-colors duration-1000 backdrop-blur-[21px]', {
        'bg-white': BGColor,
      })}
    >
      ...
      <ThemeSelector openTheme={openTheme} onThemeClose={() => setOpenTheme(false)} />
    </div>
  );
};
