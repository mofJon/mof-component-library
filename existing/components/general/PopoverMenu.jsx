...
const PopoverMenu = ({ title, open, placement, onOpen, onClose, children, className, ...props }) => {
  ...
  return (
    <div ref={wrapper} className={classNames('relative z-0', _open && 'open', className)} {...props}>
      <button
        type="button"
      ...
      <div
        className={classNames(
          ...
          placement === 'Top' ? 'bottom-full origin-bottom-right border-b-0' : 'origin-top-right border-t-0',
        )}
        tabIndex="-1"
      >
        {children}
