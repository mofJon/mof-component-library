  ...
  (() => {
    ...
    var wc = S((fU, Fc) => {
      ...
      function zD(e, t, r, n, a, o) {
        ...
        return m ? (o || (o = new mo()), jD(e, t, r, n, a, o)) : !1;
      }
      Fc.exports = zD;
    });
    var go = S((yU, _c) => {
    ...
    var yh = S((EX, gh) => {
      ...
      var NT = Xo()(),
        Zo = ut(),
        kr = NT && Zo("%Object.defineProperty%", !0);
      if (kr)
        try {
          kr({}, "a", { value: 1 });
        } catch {
    ...
    var Bh = S((wX, Hn) => {
      ...
      var ei = Mn(),
        ...
        wh = Yt("%Reflect.apply%", !0) || ei.call(Fh, Sh),
      ...
      Hn.exports = function (t) {
        ...
        var r = wh(ei, Fh, arguments);
        return MT(r, 1 + UT(0, t.length - (arguments.length - 1)), !0);
      };
      var xh = function () {
        return wh(ei, Sh, arguments);
      };
    ...
    var Zh = S((MX, Qh) => {
      ...
      Qh.exports = function e(t, r, n, a) {
        ...
        if (l8(t)) return ai("WeakMap");
        if (p8(t)) return ai("WeakSet");
        if (c8(t)) return ai("WeakRef");
        if (n8(t)) return Lr(m(Number(t)));
        if (o8(t)) return Lr(m(oi.call(t)));
      ...
      function Xh(e, t) {
        if (e.length > t.maxStringLength) {
          ...
          return Xh(pi.call(e, 0, t.maxStringLength), t) + n;
        }
...
` +
    ...
    var cm = S((rQ, lm) => {
      ...
      var um = tm(),
        ...
        Qe = Array.isArray,
        U8 = Array.prototype.push,
        sm = function (e, t) {
          U8.apply(e, Qe(t) ? t : [t]);
        },
        z8 = Date.prototype.toISOString,
        im = Mr.default,
        xe = {
          addQueryPrefix: !1,
          allowDots: !1,
        ...
        bi = {},
        G8 = function e(t, r, n, a, o, i, u, s, p, y, A, m, h, E, b, x) {
          for (
            var F = t, B = x, I = 0, q = !1;
            (B = B.get(bi)) !== void 0 && !q;
    ...
    var fm = S((iQ, pm) => {
      ...
      var Qt = yi(),
        ...
        Z8 = function (t, r, n, a) {
          if (t) {
            ...
            return s && y.push("[" + o.slice(s.index) + "]"), Q8(y, r, n, a);
          }
        },
        e_ = function (t) {
          if (!t) return Ae;
      ...
      pm.exports = function (e, t) {
        ...
        for (
          var n = typeof e == "string" ? X8(e, r) : e,
    ...
    var Ai = S((cQ, hm) => {
      ...
      var t_ = cm(),
        r_ = fm(),
        n_ = Jn();
      hm.exports = { formats: n_, parse: r_, stringify: t_ };
    });
    var Am = S((YZ, Em) => {
      l();
      c();
    ...
    var Di = S((Qn) => {
      ...
      (function () {
        "use strict";
        (Qn.ast = Am()), (Qn.code = vi()), (Qn.keyword = Cm());
      })();
    });
    var xm = S((dee, D_) => {
      D_.exports = {
...
\u2028\u2029])`;
    ...
    var nr,
      ...
      Fg = Ke(() => {
        ...
        (nr = function (e, t, r) {
          ...
          (vR = function (e, t) {
            return t === void 0 && (t = "deg"), Number(e) * (ER[t] || 1);
          }),
          (DR = function (e) {
            var t =
        ...
        (TR = typeof window < "u" ? ou : he),
          ...
          (RR = {
            ...
            toHsva: AR,
            fromHsva: function (e) {
              return xR({ h: e.h, s: e.s, v: e.v, a: 1 });
            },
            equal: wR,
          }),
          (Dg = function (e) {
            return g.createElement(OR, xt({}, e, { colorModel: RR }));
          }),
          (PR = function (e) {
            var t = e.className,
              r = e.hsva,
          ...
          (xg = function (e) {
            return g.createElement(Cg, xt({}, e, { colorModel: IR }));
          }),
          (kR = {
    ...
    var Mg = S((Ute, jg) => {
      ...
      var YR = qg(),
        JR = /^\s+/;
      function XR(e) {
        return e && e.slice(0, YR(e) + 1).replace(JR, "");
      }
      jg.exports = XR;
    });
    var Hg = S((Wte, zg) => {
    ...
    var ty = {};
    eu(ty, { ColorControl: () => ey, default: () => O4 });
    var Ne,
      Qg,
      h4,
      m4,
      ...
      ry = Ke(() => {
        ...
        Ia();
        lr();
        (h4 = j.div({ position: "relative", maxWidth: 250 })),
          (m4 = j(Xr)({ position: "absolute", zIndex: 1, top: 4, left: 4 })),
          (g4 = j.div({
            width: 200,
            margin: 5,
          ...
          (T4 = (e, t) => {
            ...
            let s = et(() => B4(r, a, i).toLowerCase(), [r, a, i]),
              p = me(
                (A) => {
                  let m = or(A),
                    h = m?.value || A || "";
          ...
          (ey = ({
            ...
            let u = me((0, Qg.default)(r, 200), [r]),
              ...
              { presets: E, addPreset: b } = _4(o, A, m),
              x = w4[m];
            return g.createElement(
              h4,
              null,
              ...
              s ? g.createElement(D4, { icon: "markup", onClick: h }) : null,
            );
          }),
          (O4 = ey);
      });
    ...
    var SI = __STORYBOOK_API__,
      {
        ...
        Provider: TI,
        addons: ga,
        combineParameters: _I,
        controlOrMetaKey: OI,
        controlOrMetaSymbol: RI,
        eventMatchesShortcut: PI,
        eventToShortcut: II,
        isMacLike: kI,
        isShortcutTaken: NI,
        keyToSymbol: LI,
        merge: qI,
        mockChannel: jI,
        optionOrAltSymbol: MI,
        shortcutMatchesShortcut: $I,
        shortcutToHumanString: UI,
        types: iu,
        useAddonState: zI,
        useArgTypes: ya,
        useArgs: uu,
    ...
    function s1(e, t) {
      ...
      var r = tt(t);
      return rt(
        De({}, r, { lightness: Ot(0, 1, r.lightness - parseFloat(e)) }),
      );
    }
    var l1 = Ie(s1),
      Me = l1;
    function c1(e, t) {
      ...
      var r = tt(t);
      return rt(
        De({}, r, { saturation: Ot(0, 1, r.saturation - parseFloat(e)) }),
      );
    }
    var _7 = Ie(c1);
    function d1(e, t) {
...
`,
      ...
      let i = [],
        ...
        s = {
          ...
          12: { match: Fr(np), order: 1, parse: () => ({}), render: Oo },
          14: {
            match: it(bF),
            order: 1,
...
`,
    ...
    c();
    d();
    var KV = __STORYBOOK_CHANNELS__,
      {
        Channel: jo,
        PostMessageTransport: YV,
        WebsocketTransport: JV,
        createBrowserChannel: E3,
        createPostMessageChannel: XV,
        createWebSocketChannel: QV,
      } = __STORYBOOK_CHANNELS__;
    l();
    c();
    d();
    var nK = __STORYBOOK_CORE_EVENTS__,
      {
        CHANNEL_CREATED: aK,
        CONFIG_ERROR: A3,
        ...
        PRELOAD_ENTRIES: F3,
        PREVIEW_BUILDER_PROGRESS: iK,
        PREVIEW_KEYDOWN: w3,
        REGISTER_SUBSCRIPTION: uK,
        REQUEST_WHATS_NEW_DATA: sK,
        RESET_STORY_ARGS: Tn,
        RESULT_WHATS_NEW_DATA: lK,
        SELECT_STORY: cK,
        SET_CONFIG: dK,
        ...
        SET_INDEX: _3,
        SET_STORIES: pK,
        SET_WHATS_NEW_CACHE: fK,
        SHARED_STATE_CHANGED: O3,
        SHARED_STATE_SET: R3,
        STORIES_COLLAPSE_ALL: hK,
        STORIES_EXPAND_ALL: mK,
        ...
        STORY_UNCHANGED: $3,
        TELEMETRY_ERROR: gK,
        TOGGLE_WHATS_NEW_NOTIFICATIONS: yK,
        UPDATE_GLOBALS: Wf,
...
`)),
    ...
    var G0 = pe(U0(), 1);
    var W0 = pe(wo(), 1);
    var BJ = (0, H0.default)(1)((e) =>
      Object.values(e).reduce(
        (t, r) => ((t[r.importPath] = t[r.importPath] || r), t),
        {},
      ),
    );
    var TJ = Symbol("incompatible");
    var _J = Symbol("Deeply equal");
    var sT = zt`
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
    ...
    var LQ = new g_.default({ escapeXML: !0 });
    var { document: qQ } = ie;
    var { FEATURES: JQ } = ie;
    l();
    c();
    ...
    var B_ = Object.create,
        ...
        if ((t && typeof t == "object") || typeof t == "function")
          for (let a of Rm(t))
            !O_.call(e, a) &&
              ...
              Om(e, a, {
                get: () => t[a],
                enumerable: !(n = T_(t, a)) || n.enumerable,
              });
        return e;
      },
      Zn = (e, t, r) => (
      ...
      I_ = ["detail"];
    function Pm(e) {
      let t = P_.filter((r) => e[r] !== void 0).reduce(
        (r, n) => ({ ...r, [n]: e[n] }),
        {},
      );
      return (
        e instanceof CustomEvent &&
          I_.filter((r) => e[r] !== void 0).forEach((r) => {
            t[r] = e[r];
          }),
        t
      );
    ...
    var V_ =
        ...
        window,
      K_ = V_,
      Y_ = typeof self == "object" && self && self.Object === Object && self,
      J_ = K_ || Y_ || Function("return this")(),
      Fi = J_,
      X_ = Fi.Symbol,
      Zt = X_,
      Um = Object.prototype,
      Q_ = Um.hasOwnProperty,
      Z_ = Um.toString,
    ...
    var cO = lO,
      dO = "[object Symbol]";
    function pO(e) {
      return typeof e == "symbol" || (cO(e) && zm(e) == dO);
    }
    var wi = pO;
    function fO(e, t) {
      for (var r = -1, n = e == null ? 0 : e.length, a = Array(n); ++r < n; )
    ...
    function CO(e) {
      if (!Gm(e)) return !1;
      var t = zm(e);
      return t == AO || t == vO || t == EO || t == DO;
    }
    var xO = CO,
      SO = Fi["__core-js_shared__"],
      xi = SO,
      Lm = (function () {
    ...
    function KO(e, t) {
      ...
      return r == "number" ||
        ...
        wi(e)
        ? !0
        : VO.test(e) || !WO.test(e) || (t != null && e in Object(t));
    }
    var YO = KO,
      JO = Wm(Object, "create"),
      Hr = JO;
    ...
    var e6 = ZO,
      t6 = "__lodash_hash_undefined__",
      r6 = Object.prototype,
      n6 = r6.hasOwnProperty;
    function a6(e) {
      var t = this.__data__;
      if (Hr) {
        var r = t[e];
        return r === t6 ? void 0 : r;
      }
    ...
    function s6(e) {
      var t = this.__data__;
      return Hr ? t[e] !== void 0 : u6.call(t, e);
    }
    var l6 = s6,
    ...
    er.prototype.clear = QO;
    er.prototype.delete = e6;
    er.prototype.get = o6;
    er.prototype.has = l6;
    er.prototype.set = p6;
    var qm = er;
    ...
    function b6(e) {
      ...
      if (r < 0) return !1;
      var n = t.length - 1;
      return r == n ? t.pop() : y6.call(t, r, 1), --this.size, !0;
    }
    var E6 = b6;
    function A6(e) {
      var t = this.__data__,
    ...
    tr.prototype.clear = h6;
    tr.prototype.delete = E6;
    tr.prototype.get = v6;
    tr.prototype.has = C6;
    tr.prototype.set = S6;
    var F6 = tr,
    ...
    function P6(e, t) {
      var r = e.__data__;
      return R6(t) ? r[typeof t == "string" ? "string" : "hash"] : r.map;
    }
    var ra = P6;
    function I6(e) {
    ...
    rr.prototype.clear = _6;
    rr.prototype.delete = k6;
    rr.prototype.get = L6;
    rr.prototype.has = j6;
    rr.prototype.set = $6;
    var Vm = rr,
    ...
    var W6 = G6,
      ...
      Y6 = W6(function (e) {
        ...
        return (
          e.charCodeAt(0) === 46 && t.push(""),
          e.replace(V6, function (r, n, a, o) {
            t.push(a ? o.replace(K6, "$1") : n || r);
          }),
          t
        );
      }),
    ...
    var Q6 = X6;
    function Z6(e, t) {
      return Bi(e) ? e : YO(e, t) ? [e] : J6(Q6(e));
    }
    var eR = Z6,
      tR = 1 / 0;
    function rR(e) {
    ...
    function aR(e, t) {
      t = eR(t, e);
      for (var r = 0, n = t.length; e != null && r < n; ) e = e[nR(t[r++])];
      return r && r == n ? e : void 0;
    }
    var oR = aR;
    function iR(e, t, r) {
...
` &&
      ...
      lR = (0, Km.default)(1e4)((e) => sR(e).replace(/\n\s*/g, "").trim()),
      cR = function (t, r) {
    ...
    var fR = function (t) {
        ...
        return function (u, s) {
          try {
            ...
            if (typeof s == "string")
              return dR.test(s) ? (t.allowDate ? `_date_${s}` : void 0) : s;
            if ((0, z_.default)(s))
          ...
          if (
            (key === "" &&
              ...
              refs.forEach(({ target: e, container: t, replacement: r }) => {
                ...
                n.length === 0 ? (t[e] = root) : (t[e] = uR(root, n));
              })),
      ...
      mR = (e, t = {}) => {
        let r = { ...Jm, ...t };
        return JSON.stringify(Ym(e), fR(r), t.space);
      },
      gR = () => {
        let e = new Map();
        return function t(r) {
    ...
    var R4 = j.div(Bt, ({ theme: e }) => ({
      ...
      xy = ({
        ...
        if (e) return g.createElement(k4, null);
        ...
        g.createElement(
          ...
          g.createElement(
            ...
            e
              ...
              : g.createElement(N4, { zoom: n, resetZoom: a }),
          ),
        ),
      j4 = sr({ scale: 1 }),
      { window: Rre } = ie;
    var { PREVIEW_URL: Pre } = ie;
    var M4 = j.div(
    ...
    var H4 = j(q4)({
      ...
      G4 = j.div({ overflow: "hidden", position: "relative" }),
      W4 = ({
        isLoading: e,
        isColumn: t,
        columns: r,
        ...
        let [A, m] = te(i),
          { source: h, actionItem: E } = U4(a, A, m),
          [b, x] = te(1),
    ...
    var V4 = j.table(({ theme: e }) => ({
      ...
      Y4 = j.span(wt, ({ theme: e, simple: t = !1 }) => ({
        flex: "0 0 auto",
        fontFamily: e.typography.fonts.mono,
        fontSize: e.typography.size.s1,
      ...
      Z4 = j(Be)({ height: 10, width: 10, minWidth: 10, marginLeft: 4 }),
      e9 = () => g.createElement("span", null, "-"),
      Sy = ({ text: e, simple: t }) => g.createElement(Y4, { simple: t }, e),
      t9 = (0, by.default)(1e3)((e) => {
        let t = e.split(/\r?\n/);
      ...
      n9 = ({ value: e, initialExpandedArgs: t }) => {
        ...
        return g.createElement(
          ...
          g.createElement(
            ...
            g.createElement(Z4, { icon: a ? "arrowup" : "arrowdown" }),
          ),
        );
      },
      $i = ({ value: e, initialExpandedArgs: t }) =>
        e == null
          ? g.createElement(e9, null)
          : g.createElement(n9, { value: e, initialExpandedArgs: t }),
      a9 = j.label(({ theme: e }) => ({
        lineHeight: "18px",
        alignItems: "center",
        marginBottom: 8,
      ...
      o9 = (e) => e === "true",
      i9 = ({ name: e, value: t, onChange: r, onBlur: n, onFocus: a }) => {
        let o = me(() => r(!1), [r]);
        if (t === void 0)
          return g.createElement(
            Te.Button,
      ...
      p9 = ({ name: e, value: t, onChange: r, onFocus: n, onBlur: a }) => {
        ...
        he(() => {
          o !== !1 &&
            (u && u.current && (u.current.value = l9(t)),
            s && s.current && (s.current.value = c9(t)));
        }, [t]);
        let p = (m) => {
    ...
    Ny.defaultProps = {
      ...
      logger: { error: () => {} },
      onSubmitValueParser: (e, t, r, n, a) => U9(a),
    ...
    var { window: z9 } = ie,
      ...
      K9 = (e) => {
        e.currentTarget.dispatchEvent(new z9.KeyboardEvent("keydown", V9));
      },
      Y9 = (e) => {
          ...
          i
            ...
            : g.createElement(Ny, {
                ...
                inputElement: (x, F, B, I) =>
                  I
                    ? g.createElement(dy, { onFocus: Y9, onBlur: K9 })
      ...
      Q9 = j(Ly)(({ numberOFDecimalsPlaces: e, max: t }) => ({
        width: `${e + t.toString().length * 2 + 3}ch`,
        textAlign: "right",
        flexShrink: 0,
      })),
      Z9 = j.div({ display: "flex", alignItems: "center", width: "100%" });
    function eP(e) {
    ...
    var uP = ({ onChange: e, name: t, accept: r = "image/*", value: n }) => {
      ...
      sP = au(() => Promise.resolve().then(() => (ry(), ty))),
      lP = (e) =>
        g.createElement(
          nu,
          { fallback: g.createElement("div", null) },
          g.createElement(sP, { ...e }),
        ),
      cP = {
        array: py,
        object: py,
      ...
      dP = ({ row: e, arg: t, updateArgs: r, isHovered: n }) => {
      ...
      ca = (e) => {
        ...
        return g.createElement(
          ...
          g.createElement(
            ...
            h ? g.createElement(fP, { title: "Required" }, "*") : null,
          ),
          o
            ? null
            : g.createElement(
                "td",
                null,
                E && g.createElement(hP, null, g.createElement(gp, null, p)),
                y.jsDocTags != null
                  ? g.createElement(
                      g.Fragment,
                      null,
                      ...
                      g.createElement(K4, { tags: y.jsDocTags }),
                    )
                  : g.createElement(
                      mP,
                      { hasDescription: E },
          ...
          a
            ? g.createElement(
                "td",
                null,
                g.createElement(dP, { ...e, isHovered: t }),
              )
            : null,
        );
      },
        ...
        return g.createElement(
          ...
          g.createElement(
            ...
            g.createElement(
              ...
              g.createElement(EP, null, g.createElement(bP, { icon: y }), t),
            ),
            g.createElement(
              DP,
              { colSpan: a - 1 },
      ...
      SP = j.div(({ inAddonPanel: e, theme: t }) => ({
        height: e ? "100%" : "auto",
        display: "flex",
      ...
      RP = j.table(({ theme: e, compact: t, inAddonPanel: r }) => ({
        "&&": {
          borderSpacing: 0,
          color: e.color.defaultText,
          "td, th": {
      ...
      IP = j.span({ display: "flex", justifyContent: "space-between" }),
      kP = {
      ...
      St = (e) => {
        ...
        if (u) return g.createElement(xP, null);
        let { rows: s, args: p, globals: y } = "rows" in e && e,
          A = NP(
            (0, yy.default)(
              s,
              (B) => !B?.table?.disable && LP(B, p || {}, y || {}),
            ),
            i,
          ),
        ...
        if (m && h && E) return g.createElement(OP, { inAddonPanel: a });
        let b = 1;
        t && (b += 1), n || (b += 2);
      ...
      qre = j.div(Bt, ({ theme: e }) => ({
        ...pa(e),
        margin: "25px 0 40px",
        padding: "30px 20px",
      }));
    var jre = j.div(({ theme: e }) => ({
        fontWeight: e.typography.weight.bold,
        color: e.color.defaultText,
      })),
      Mre = j.div(({ theme: e }) => ({
      ...
      $re = j.div({ flex: "0 0 30%", lineHeight: "20px", marginTop: 5 }),
      Ure = j.div(({ theme: e }) => ({
        flex: 1,
        textAlign: "center",
        fontFamily: e.typography.fonts.mono,
      ...
      zre = j.div({ display: "flex", flexDirection: "row" }),
      Hre = j.div(({ background: e }) => ({
        position: "relative",
        flex: 1,
        "&::before": {
          position: "absolute",
      ...
      Vre = j.div({ flex: 1, display: "flex", flexDirection: "row" }),
      Kre = j.div({ display: "flex", alignItems: "flex-start" }),
      Yre = j.div({ flex: "0 0 30%" }),
      Jre = j.div({ flex: 1 }),
      Xre = j.div(({ theme: e }) => ({
        display: "flex",
        flexDirection: "row",
    ...
    var Zre = j.div(({ theme: e }) => ({
      ...
      rne = j.div({ display: "flex", flexFlow: "row wrap" });
    ie &&
  ...
  `);
    ...
    var { document: lne, window: cne } = ie;
    var ZP = ({ children: e, disableAnchor: t, ...r }) => {
      ...
      ga.add(zy, {
        ...
        render: ({ active: t }) =>
          !t || !e.getCurrentStoryData()
            ? null
            : g.createElement(Ea, { active: t }, g.createElement(eI, null)),
      });
    });
  })();
} catch (e) {
