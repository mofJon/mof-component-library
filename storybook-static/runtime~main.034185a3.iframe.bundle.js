(() => {
  ...
  (__webpack_require__.m = __webpack_modules__),
    ...
    (__webpack_require__.u = (chunkId) =>
      (({
        186: "components-Box-Box-stories",
        576: "components-Stack-Stack-stories",
        747: "components-Button-Button-stories",
        769: "stories-Configure-mdx",
        874: "components-Text-Text-stories",
      })[chunkId] || chunkId) +
      "." +
      {
        186: "30f5a7a8",
    ...
    (__webpack_require__.l = (url, done, key, chunkId) => {
      if (inProgress[url]) inProgress[url].push(done);
        ...
        if (void 0 !== key)
          for (
            ...
            if (
              ...
              s.getAttribute("data-webpack") == "component-library:" + key
            ) {
              script = s;
              break;
            }
        ...
        script ||
          ...
          script.setAttribute("data-webpack", "component-library:" + key),
          (script.src = url)),
          (inProgress[url] = [done]);
    ...
    (() => {
      ...
      var webpackJsonpCallback = (parentChunkLoadingFunction, data) => {
        ...
        chunkLoadingGlobal = (self.webpackChunkcomponent_library =
